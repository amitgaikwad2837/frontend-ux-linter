# v0.1 Engineering Backlog - Frontend UX Linter

## 1. Release Objective

- Product Type: CLI
- Primary Command/API: ux-lint
- v0.1 Goal: Analyze frontend flows for friction, missing states, form complexity, and accessibility anti-patterns.
...
frontend source path, optional design rules config

### Outputs

lint findings in terminal/json, severity counts, remediation hints
...
- Core Acceptance Test: Given React fixture with missing loading/empty/error states, command reports expected findings and severities.
